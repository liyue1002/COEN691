 ...
 */
google.devrel.samples.hello.getCommentList = function(topicTitle) {
...
google.devrel.samples.hello.enableButtons = function() {
    ...
    document.getElementById('getCommentList').onclick = function() {
    	console.log("enable button");
	    google.devrel.samples.hello.getCommentList(document.getElementById('topicTitle').value);
	  }
