...
google.devrel.samples.hello.viewShareResume = function(selfName, nameOfResume) {
	  gapi.client.helloworld.greetings.viewShareResume({'selfName': selfName,  'nameOfResume': nameOfResume}).execute(
	      function(resp) {
	        if (!resp.code) {
	        	console.log(resp);
...
google.devrel.samples.hello.enableButtons = function() {
    ...
    document.getElementById('viewShareResume').onclick = function() {
	    google.devrel.samples.hello.viewShareResume(
	        document.getElementById('selfName').value,
	        document.getElementById('nameOfResume').value);
	  }
